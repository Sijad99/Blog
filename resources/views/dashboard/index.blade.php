...
@section('body')
            ...
            <div class="overflow-auto h-screen pb-24 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
                        ...
                        <div class="flex flex-wrap -m-4 text-center">
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div class="bg-blue-500 px-4 py-6 rounded-lg">
                                    ...
                                    <p class="leading-relaxed text-white">بازدید</p>
                                </div>
                            </div>
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            ...
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div class="bg-indigo-500 px-4 py-6 rounded-lg">
                                    ...
                                    <p class="leading-relaxed text-white">پست ها</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                    ...
                    <h2 class="text-gray-900 font-medium tracking-wider text-sm mb-1">وینستون چرچیل</h2>
